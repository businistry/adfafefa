...
@InputType()
class AppointmentCreateNestedManyWithoutNotariesInput {
...
export { AppointmentCreateNestedManyWithoutNotariesInput as AppointmentCreateNestedManyWithoutNotariesInput };
