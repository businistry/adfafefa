...
export class AppointmentServiceBase {
  ...
  async findNotaryServicePerformeds(
    parentId: string,
    args: Prisma.NotaryServicePerformedFindManyArgs
  ): Promise<PrismaNotaryServicePerformed[]> {
    return this.prisma.appointment
      .findUniqueOrThrow({
        where: { id: parentId },
      })
      .notaryServicePerformeds(args);
  }

  async getNotary(parentId: string): Promise<PrismaNotary | null> {
    return this.prisma.appointment
      .findUnique({
        where: { id: parentId },
      })
  ...
  async CancelAppointment(args: UpdateAppointmentArgs): Promise<Appointment> {
    throw new Error("Not implemented");
  }
  async ConfirmAppointment(args: UpdateAppointmentArgs): Promise<Appointment> {
    throw new Error("Not implemented");
  }
  ...
  async ScheduleAppointment(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
}
